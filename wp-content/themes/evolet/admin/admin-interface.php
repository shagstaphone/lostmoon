...
/*    $of_page = add_submenu_page('themes.php', THEMENAME, 'Evolet Options', 'edit_theme_options', 'optionsframework','optionsframework_options_page'); // Default*/

$of_page = add_theme_page(THEMENAME, 'Evolet Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
